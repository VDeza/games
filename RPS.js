...
function vs() {
    ...
    if (player == "Batu") {
        player = "Rock";
        hasil = "";
        document.getElementById("bpemain").src = "/images/rocks.png";
        document.getElementById("bbot").src = "/images/question.png";

    } else if (player == "Gunting") {
        player = "Scissor";
        hasil = "";
        document.getElementById("bpemain").src = "/images/scissor.png";
        document.getElementById("bbot").src = "/images/question.png";

    } else if (player == "Kertas") {
        player = "Paper";
        hasil = "";
        document.getElementById("bpemain").src = "/images/paper.png";
        document.getElementById("bbot").src = "/images/question.png";
        ...
        document.getElementById("bpemain").src = "/images/question.png";
        document.getElementById("bbot").src = "/images/question.png";
...
function rPS() {
    ...
    if (bot == 0) {
        bot = "Rock";
        document.getElementById("bbot").src = "/images/rocks.png";
    } else if (bot == 1) {
        bot = "Scissor";
        document.getElementById("bbot").src = "/images/scissor.png";
    } else {
        bot = "Paper";
        document.getElementById("bbot").src = "/images/paper.png";
    }
